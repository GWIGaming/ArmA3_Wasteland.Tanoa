...
[
	...
	["SPAR-16 Rifle [DLC]", "arifle_SPAR_01_khk_F", 200],
	["SPAR-16 Rifle [DLC]", "arifle_SPAR_01_blk_F", 200],
	["SPAR-16 GL Rifle [DLC]", "arifle_SPAR_01_GL_blk_F", 200],
	["SPAR-16 GL Rifle [DLC]", "arifle_SPAR_01_GL_khk_F", 200],
	
	["CAR-95 Rifle [DLC]", "arifle_CTAR_blk_F", 200],
	["CAR-95 GL Rifle [DLC]", "arifle_CTAR_GL_blk_F", 250],
	["Type 115 Rifle (Green Hex) [DLC]", "arifle_ARX_ghex_F", 300],
	["Type 115 Rifle (Black) [DLC]", "arifle_ARX_blk_F", 300],
	...
	// DLC
	["CMR-76 Rifle (Black) [DLC]", "srifle_DMR_07_blk_F", 450],
	["CMR-76 Rifle (Khaki) [DLC]", "srifle_DMR_07_khk_F", 450],
	["SPAR-17 Rifle (Black) [DLC]", "arifle_SPAR_03_blk_F", 450],
	["SPAR-17 Rifle (Khaki) [DLC]", "arifle_SPAR_03_khk_F", 450],
	...
	["MAR-10 Rifle [DLC]", "srifle_DMR_02_F", 750, "HIDDEN"],
	["MAR-10 Rifle (Camo) [DLC]", "srifle_DMR_02_camo_F", 800, "HIDDEN"],
	["MAR-10 Rifle (Sand) [DLC]", "srifle_DMR_02_sniper_F", 800, "HIDDEN"],
	["Cyrus Rifle [DLC]", "srifle_DMR_05_blk_F", 750, "HIDDEN"],
	["Cyrus Rifle (Hex) [DLC]", "srifle_DMR_05_hex_F", 800, "HIDDEN"],
	["Cyrus Rifle (Tan) [DLC]", "srifle_DMR_05_tan_f", 800, "HIDDEN"],
	...
	["GM6 Lynx Sniper (Green Hex) [DLC]", "srifle_GM6_ghex_LRPS_F", 1500, "HIDDEN"],
...
[
	["MX SW LMG (Khaki)", "arifle_MX_SW_khk_F", 300],
	["MX SW LMG (Black)", "arifle_MX_SW_Black_F", 325],
	["Mk200 LMG", "LMG_Mk200_F", 400],
	["Zafir LMG", "LMG_Zafir_F", 500],

	["SPAR-16S Rifle [DLC]", "arifle_SPAR_02_khk_F", 200],
	["SPAR-16S Rifle [DLC]", "arifle_SPAR_02_blk_F", 200],
	["CAR-95-1 LMG [DLC]", "arifle_CTARS_blk_F", 300],
	["LIM-85 LMG [DLC]", "LMG_03_F", 350],

	["SPMG MMG (Sand) [DLC]", "MMG_02_sand_F", 750, "HIDDEN"],
	["SPMG MMG (MTP) [DLC]", "MMG_02_camo_F", 750, "HIDDEN"],
	["SPMG MMG (Black) [DLC]", "MMG_02_black_F", 800, "HIDDEN"],
	["Navid MMG (Tan) [DLC]", "MMG_01_tan_F", 1000, "HIDDEN"],
	["Navid MMG (Hex) [DLC]", "MMG_01_hex_F", 1000, "HIDDEN"]
];
...
[
	...
	["Titan MPRL Compact (Sand)", "launch_Titan_short_F", 500, "HIDDEN"],
	["Titan MPRL Compact (Coyote)", "launch_O_Titan_short_F", 500, "HIDDEN"],
	["Titan MPRL Compact (Olive)", "launch_I_Titan_short_F", 500, "HIDDEN"],
	["Titan MPRL AA (Sand)", "launch_Titan_F", 600, "HIDDEN"],
	["Titan MPRL AA (Hex)", "launch_O_Titan_F", 600, "HIDDEN"],
	["Titan MPRL AA (Digi)", "launch_I_Titan_F", 600, "HIDDEN"]
];
...
[
	...
	["RPG-7VM HEAT Grenade", "RPG7_F", 200],                   // Direct damage: medium    | Splash damage: low    | Guidance: none
	...
	["Titan Anti-Tank Missile", "Titan_AT", 350, "HIDDEN"],             // Direct damage: high      | Splash damage: low    | Guidance: mouse, laser, ground vehicles
	["Titan Anti-Personnel Missile", "Titan_AP", 350, "HIDDEN"],        // Direct damage: low       | Splash damage: high   | Guidance: mouse, laser
	["Titan Anti-Air Missile", "Titan_AA", 350, "HIDDEN"],              // Direct damage: low       | Splash damage: medium | Guidance: aircraft
...
[
	...
	["Suppressor 6.5 [Green] [DLC]", "muzzle_snds_65_TI_blk_F", 250, "item", "HIDDEN"],
	["Suppressor 6.5 [Black] [DLC]", "muzzle_snds_65_TI_ghex_F", 250, "item", "HIDDEN"],
	["Suppressor 6.5 [Hex] [DLC]", "muzzle_snds_65_TI_hex_F", 250, "item", "HIDDEN"],
...
[
	...
	["Special Purpose Helmet [Green Hex] [DLC]", "H_HelmetO_ViperSP_ghex_F", 500, "hat", "HIDDEN"],
	["Special Purpose Helmet [Hex] [DLC]", "H_HelmetO_ViperSP_hex_F", 500, "hat", "HIDDEN"],
...
[
	...
	["Bergen (Digital) [DLC]", "B_Bergen_dgtl_F", 1500, "backpack"],
	["Bergen (Hex) [DLC]", "B_Bergen_hex_F", 1500, "backpack"],
	["Bergen (MTP) [DLC]", "B_Bergen_mcamo_F", 1500, "backpack"],
	["Bergen (Tropic) [DLC]", "B_Bergen_tna_F", 1500, "backpack"]
];
...
[
	...
	["Remote Designator Bag (NATO) [DLC]", "B_Static_Designator_01_weapon_F", 250, "backpack", "HIDDEN"],
	["Remote Designator Bag (CSAT) [DLC]", "O_Static_Designator_02_weapon_F", 250, "backpack", "HIDDEN"],
	["GPS", "ItemGPS", 100, "gps"],
	...
	["Laser Designator (Sand)", "Laserdesignator", 250, "binoc", "HIDDEN"], // Increase price to 2500 if A3W_disableBuiltInThermal = 0
	["Laser Designator (Hex)", "Laserdesignator_02", 250, "binoc", "HIDDEN"],
	["Laser Designator (Olive)", "Laserdesignator_03", 250, "binoc", "HIDDEN"],
...
[
	...
	["Hatchback Sport", "C_Hatchback_01_sport_F", 5, "vehicle"],  //It's the fastest car in the game
	...
	//["HEMTT Repair", "B_Truck_01_Repair_F", 12500, "vehicle", "HIDDEN"],
	//["HEMTT Ammo", "B_Truck_01_ammo_F", 27500, "vehicle", "HIDDEN"],
	...
	//["Tempest Ammo", "O_Truck_03_ammo_F", 27500, "vehicle", "HIDDEN"],
	...
	//["Zamak Repair", "I_Truck_02_box_F", 10000, "vehicle", "HIDDEN"],
	//["Zamak Ammo", "I_Truck_02_ammo_F", 25000, "vehicle", "HIDDEN"],

	//["UGV Stomper (NATO)", "B_UGV_01_F", 2500, "vehicle", "HIDDEN"],
	//["UGV Stomper RCWS (NATO)", "B_UGV_01_rcws_F", 15000, "vehicle", "HIDDEN"],
	//["UGV Stomper (AAF)", "I_UGV_01_F", 2500, "vehicle", "HIDDEN"],
	//["UGV Stomper RCWS (AAF)", "I_UGV_01_rcws_F", 15000, "vehicle", "HIDDEN"],
	//["UGV Saif (CSAT)", "O_UGV_01_F", 2500, "vehicle", "HIDDEN"],
	//["UGV Saif RCWS (CSAT)", "O_UGV_01_rcws_F", 15000, "vehicle", "HIDDEN"]
];
...
[
	...
	//["IFV-6a Cheetah AA", "B_APC_Tracked_01_AA_F", 40000, "vehicle", "HIDDEN"],
	//["ZSU-39 Tigris AA", "O_APC_Tracked_02_AA_F", 40000, "vehicle", "HIDDEN"],
	["M2A1 Slammer", "B_MBT_01_cannon_F", 50000, "vehicle"]
	//["M2A4 Slammer HMG", "B_MBT_01_TUSK_F", 50000, "vehicle", "HIDDEN"], // Commander gun variant
	//["T-100 Varsuk", "O_MBT_02_cannon_F", 50000, "vehicle", "HIDDEN"],
	//["MBT-52 Kuma", "I_MBT_03_cannon_F", 50000, "vehicle", "HIDDEN"]
];
...
[
	...
	//["Mi-290 Taru (Repair) [DLC]", "O_Heli_Transport_04_repair_F", 15000, "vehicle", "HIDDEN"],
	//["Mi-290 Taru (Ammo) [DLC]", "O_Heli_Transport_04_ammo_F", 25000, "vehicle", "HIDDEN"],
	...
	//["AH-9 Pawnee", "B_Heli_Light_01_armed_F", 30000, "vehicle", "HIDDEN"], // Armed AH-6
	//["PO-30 Orca (Armed, Black)", "O_Heli_Light_02_v2_F", 30000, "vehicle", "HIDDEN"], // Armed Ka-60 with orca paintjob
	//["PO-30 Orca (Armed, Hex)", "O_Heli_Light_02_F", 35000, "vehicle", "HIDDEN"], // Armed Ka-60
	//["WY-55 Hellcat (Armed)", "I_Heli_light_03_F", 40000, "vehicle", "HIDDEN"], // Armed AW159
	//["AH-99 Blackfoot", "B_Heli_Attack_01_F", 50000, "vehicle", "HIDDEN"], // RAH-66 with gunner
	//["Mi-48 Kajman", "O_Heli_Attack_02_F", 60000, "vehicle", "HIDDEN"], // Mi-28 with gunner

	//["MQ-12 Falcon UAV [DLC]", "B_T_UAV_03_F", 50000, "vehicle", "HIDDEN"]
];
...
[
	...
	//["A-164 Wipeout CAS", "B_Plane_CAS_01_F", 60000, "vehicle", "HIDDEN"],
	//["To-199 Neophron CAS", "O_Plane_CAS_02_F", 60000, "vehicle", "HIDDEN"],

	["V-44 X Blackfish (Infantry) [DLC]", "B_T_VTOL_01_infantry_F", 20000, "vehicle"]
	//["V-44 X Blackfish (Gunship) [DLC]", "B_T_VTOL_01_armed_F", 60000, "vehicle", "HIDDEN"],
	//["Y-32 Xi'an [DLC]", "O_T_VTOL_02_infantry_F", 60000, "vehicle", "HIDDEN"],

	//["MQ4A Greyhawk Missile UAV", "B_UAV_02_F", 20000, "vehicle", "HIDDEN"],
	//["MQ4A Greyhawk Bomber UAV", "B_UAV_02_CAS_F", 10000, "vehicle", "HIDDEN"], // Bomber UAVs are a lot harder to use, hence why they are cheaper than Missile ones
	//["K40 Ababil-3 Missile UAV (CSAT)", "O_UAV_02_F", 20000, "vehicle", "HIDDEN"],
	//["K40 Ababil-3 Bomber UAV (CSAT)", "O_UAV_02_CAS_F", 10000, "vehicle", "HIDDEN"],
	//["K40 Ababil-3 Missile UAV (AAF)", "I_UAV_02_F", 20000, "vehicle", "HIDDEN"],
	//["K40 Ababil-3 Bomber UAV (AAF)", "I_UAV_02_CAS_F", 10000, "vehicle", "HIDDEN"],

	//["KH-3A Fenghuang UAV [DLC]", "O_T_UAV_04_CAS_F", 20000, "vehicle", "HIDDEN"]
];
...
[
	...
	["Spawn Bacon", "spawnbeacon", localize "STR_WL_ShopDescriptions_spawnBeacon", "client\icons\spawnbeacon.paa", 3000, 750],
